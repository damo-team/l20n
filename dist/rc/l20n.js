(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["l20n"] = factory(require("react"), require("react-dom"));
	else
		root["l20n"] = factory(root["react"], root["react-dom"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _l20nNative = __webpack_require__(17);

	Object.keys(_l20nNative).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _l20nNative[key];
	    }
	  });
	});

	var _l20nShape = __webpack_require__(7);

	Object.keys(_l20nShape).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _l20nShape[key];
	    }
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _l20nCommon = __webpack_require__(9);

	var _jsonParser = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.l20nShape = undefined;

	var _react = __webpack_require__(8);

	var l20nShape = exports.l20nShape = _react.PropTypes.shape({
	  update: _react.PropTypes.func.isRequired,
	  hasReady: _react.PropTypes.func.isRequired,
	  get: _react.PropTypes.func.isRequired,
	  getAsync: _react.PropTypes.func.isRequired,
	  parse: _react.PropTypes.func.isRequired,
	  getNS: _react.PropTypes.func.isRequired,
	  getNSAsync: _react.PropTypes.func.isRequired
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _translateDocument = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.L20nProvider = undefined;
	...
	exports.pureMessage = pureMessage;
	...
	var notByDefaultMessage = !window.navigator.defaultLanguageMessage;
	if (notByDefaultMessage) {
	  window.navigator.defaultLanguageMessage = {};
	}

	function defineMessage(obj, attribute) {
	  var id = void 0,
	      message = '',
	      plural = '';
	  if (Object(obj) === obj) {
	    ...
	    if (message) {
	      ...
	      if (Object(plural) === plural) {
	        ...
	        plural = JSON.stringify(_defineProperty({}, plural.name, plural.value));
	      ...
	      if (obj.pure) {
	        ...
	        return _react2.default.createElement(
	          'span',
	          { 'data-l20n': id, 'data-l20n-args': plural },
	          message
	        );
	      }
	    } else {
	...
	function pureMessage(id, message, noPure) {
	  if (notByDefaultMessage) {
	    window.navigator.defaultLanguageMessage[id] = message;
	  } else {
	    message = window.navigator.defaultLanguageMessage[id] || message;
	...
	function formatMessage(msg, pure) {
	  if (_react2.default.isValidElement(msg)) {
	    var props = msg.props['data-l20n-args'];
	    if (props) {
	      try {
	    ...
	    if (msg.pure) {
	      ...
	      return _react2.default.createElement(
	        'span',
	        { 'data-l20n': msg.id, 'data-l20n-args': plural },
	        document.l20n.get(msg.id, plural) || window.navigator.defaultLanguageMessage[msg.id] || msg.id
	      );
	    }
	  } else {
	    if (pure) {
	      ...
	      return _react2.default.createElement(
	        'span',
	        { 'data-l20n': msg },
	        document.l20n.get(msg) || window.navigator.defaultLanguageMessage[msg] || msg
	      );
	    }
	  }
	}

	function formatPlural(args) {
	  return JSON.stringify(args);
	}

	var L20nProvider = exports.L20nProvider = (_temp = _class = function (_Component) {
	  _inherits(L20nProvider, _Component);

	  _createClass(L20nProvider, [{
	    key: 'getChildContext',
	  ...
	  function L20nProvider(props, context) {
	    _classCallCheck(this, L20nProvider);

	    var _this = _possibleConstructorReturn(this, (L20nProvider.__proto__ || Object.getPrototypeOf(L20nProvider)).call(this, props, context));
	    ...
	    document.l20n.ready(function (lang) {
	      ...
	      _this.props.onChangeLanguage && _this.props.onChangeLanguage(lang.code);
	      _this.setState({
	        lang: lang
	      });
	    });

	    var changeLanguage = document.l20n.changeLanguage;
	    document.l20n.changeLanguage = function (lang) {
	      var promise = changeLanguage.call(document.l20n, lang);
	  ...
	  return L20nProvider;
	}(_react.Component), _class.displayName = 'L20nProvider', _class.propTypes = {
	  children: _react.PropTypes.element.isRequired
	}, _class.childContextTypes = {
	  l20n: _l20nShape.l20nShape.isRequired
	}, _temp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _remote = __webpack_require__(11);

	var _l20nContext = __webpack_require__(14);
