...
/***/ function(module, exports, __webpack_require__) {
	...
	var _l20nNative = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shims = __webpack_require__(5);

	var _langs = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _translateDocument = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.L20nDirective = L20nDirective;
	...
	var name = _key.l20nName.NAME.split('-').pop();
	// data-l20n-optios => l20nOptions
	var optionName = camelCase(_key.l20nName.OPTIONS.split('-').slice(1));
	...
	function L20nDirective(l20n, $rootScope) {
	  return {
	    restrict: 'A',
	    priority: 1,
	    ...
	    link: function link(scope, element, attrs, ctrls) {
	      ...
	      attrs.$observe(optionName, function (options) {
	        ...
	        // }
	        console.log(options);
	        element.attr(_key.l20nName.ATTRIBUTE, options); //同步给data-l20n-args
	      });
	    }
	  };
	}
...
/***/ function(module, exports) {
	...
	exports.L20nProvider = L20nProvider;
	function L20nProvider() {
	  this.$get = function () {
	    return document.l20n;
	  };
	}
